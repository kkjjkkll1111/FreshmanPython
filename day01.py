...
#예상 출력값 적어보고 실제로 주석 풀어서 실행해 보고
#sep안에 있는 값을 한번 바꿔 보는것도 추천
...
# 6. 비교연산자와 불린(bool) <== is는 조건문때 다시 사용해보는 걸로
...
True <= 1, Flase <= 0
으로 알고 있으면 됨
조건문에서 많이 보일 거임 (True가 참, Flase가 거짓)
...
"""
#1번(안씀)
print("나의 이름은 " + name + "이고, 나이는 " + str(age) + "입니다")
